...
def frame_test_6G():
    ANIMATION_LEFT_DOWN = [(159, 20, 84, 92), (159, 250, 89, 92), (159, 140, 89, 92), (159, 250, 89, 92),
                           (159, 20, 84, 92),
                           (159, 442, 89, 96), (162, 344, 89, 92), (159, 442, 89, 96)]
    return ANIMATION_LEFT_DOWN


def frame_test_7G():
    ANIMATION_LEFT = [(310, 17, 70, 92), (306, 250, 105, 92), (300, 140, 105, 92), (306, 250, 105, 92),
                      (310, 17, 70, 92),
...
def frame_test_8G():
    ANIMATION_LEFT_UP = [(456, 14, 84, 92), (456, 246, 89, 92), (456, 136, 89, 92), (456, 246, 89, 92),
                         (456, 14, 84, 92),
                         (456, 443, 89, 96), (456, 345, 89, 92), (456, 443, 89, 96)]  #
    return ANIMATION_LEFT_UP


def frame_test_2G():
    ANIMATION_RIGHT_UP = [(940, 14, 84, 92), (940, 246, 89, 92), (940, 136, 89, 92), (940, 246, 89, 92),
                          (940, 14, 84, 92),
                          (940, 443, 89, 96), (940, 345, 89, 92), (940, 443, 89, 96)]  #
    return ANIMATION_RIGHT_UP
...
def frame_test_6S():
    ...
    return ANIMATION_Stay_LEFT_DOWN


def frame_test_7S():
    ANIMATION_Stay_LEFT = [(310, 17, 70, 92), (310, 17, 70, 92), (310, 17, 70, 92), (310, 17, 70, 92),
                           (310, 17, 70, 92),
                           (310, 17, 70, 92), (310, 17, 70, 92), (310, 17, 70, 92)]
    return ANIMATION_Stay_LEFT


def frame_test_8S():
    ANIMATION_Stay_LEFT_UP = [(456, 14, 84, 92), (456, 14, 84, 92), (456, 14, 84, 92), (456, 14, 84, 92),
                              (456, 14, 84, 92),
                              (456, 14, 84, 92), (456, 14, 84, 92), (456, 14, 84, 92)]
    return ANIMATION_Stay_LEFT_UP


def frame_test_1S():
    ANIMATION_Stay_UP = [(620, 14, 84, 92), (620, 14, 84, 92), (620, 14, 84, 92), (620, 14, 84, 92), (620, 14, 84, 92),
                         (620, 14, 84, 92), (620, 14, 84, 92), (620, 14, 84, 92)]
    return ANIMATION_Stay_UP
...
def frame_test_2S():
    ...
    return ANIMATION_Stay_RIGHT_UP
...
def frame_test_4S():
    ...
    return ANIMATION_Stay_RIGHT_DOWN


def frame_test_5A():
    ANIMATION_Stay_DOWN = [(5, 565, 130, 92), (5, 665, 130, 92), (5, 810, 130, 92), (5, 910, 130, 120),
                           (5, 565, 130, 92), (5, 665, 130, 92), (5, 810, 130, 92), (5, 910, 130, 120)]
    return ANIMATION_Stay_DOWN
...
def frame_grunt_6S():
    ...
    return ANIMATION_Grunt_LEFT_DOWN
...
def frame_grunt_8S():
    ...
    return ANIMATION_Grunt_LEFT_UP


def frame_grunt_1S():
    ANIMATION_Grunt_UP = [(628, 12, 80, 94), (628, 118, 86, 94), (628, 228, 86, 94), (628, 118, 86, 94),
                          (628, 12, 80, 94),
                          (628, 342, 86, 94), (628, 442, 88, 94), (628, 342, 86, 94)]
    return ANIMATION_Grunt_UP
...
def frame_grunt_2S():
    ...
    return ANIMATION_Grunt_RIGHT_UP
...
def frame_grunt_5S():
    ...
    return ANIMATION_Grunt_RIGHT_DOWN
    # стоит


def frame_grunt_5G():
    ANIMATION_Grunt_Stay_DOWN = [(32, 12, 80, 94), (32, 12, 80, 94), (32, 12, 80, 94), (32, 12, 80, 94),
                                 (32, 12, 80, 94),
                                 (32, 12, 80, 94), (32, 12, 80, 94), (32, 12, 80, 94)]
    return ANIMATION_Grunt_Stay_DOWN
...
def frame_grunt_6G():
    ...
    return ANIMATION_Grunt_Stay_LEFT_DOWN
...
def frame_grunt_7G():
    ...
    return ANIMATION_Grunt_Stay_LEFT
...
def frame_grunt_8G():
    ...
    return ANIMATION_Grunt_Stay_LEFT_UP
...
def frame_grunt_1G():
    ...
    return ANIMATION_Grunt_Stay_UP
...
def frame_grunt_2G():
    ...
    return ANIMATION_Grunt_Stay_RIGHT_UP
...
def frame_grunt_3G():
    ...
    return ANIMATION_Grunt_Stay_RIGHT
...
def frame_grunt_4G():
    ...
    return ANIMATION_Grunt_Stay_RIGHT_DOWN

    # анимация для тестового героя
    # передвижение


def frame_footmen_5G():
    ANIMATION_Footmen_DOWN = [(33, 19, 64, 92), (38, 250, 64, 92), (41, 140, 64, 92), (38, 250, 64, 92),
                              (33, 19, 64, 92),
                              (32, 445, 64, 92), (32, 349, 66, 92), (32, 445, 64,
                                                                     92)]
    return ANIMATION_Footmen_DOWN


def frame_footmen_6G():
    ANIMATION_Footmen_LEFT_DOWN = [(159, 20, 84, 92), (159, 250, 89, 92), (159, 140, 89, 92), (159, 250, 89, 92),
                                   (159, 20, 84, 92), (159, 442, 89, 96), (162, 344, 89, 92), (159, 442, 89,
                                                                                               96)]
    return ANIMATION_Footmen_LEFT_DOWN


def frame_footmen_7G():
    ...
    return ANIMATION_Footmen_LEFT


def frame_footmen_8G():
    ...
    return ANIMATION_Footmen_LEFT_UP


def frame_footmen_1G():
    ...
    return ANIMATION_Footmen_UP


def frame_footmen_2G():
    ...
    return ANIMATION_Footmen_RIGHT_UP


def frame_footmen_3G():
    ANIMATION_Footmen_RIGHT = [(1088, 17, 70, 92), (1088, 250, 105, 92), (1088, 140, 105, 92), (1088, 250, 105, 92),
                               (1088, 17, 70, 92), (1088, 445, 105, 92), (1088, 350, 105, 92), (1088, 445, 105, 92)]

    return ANIMATION_Footmen_RIGHT


def frame_footmen_4G():
    ANIMATION_Footmen_RIGHT_DOWN = [(1232, 19, 84, 92), (1232, 252, 89, 92), (1232, 140, 89, 92), (1232, 252, 89, 92),
                                    (1232, 19, 84, 92), (1232, 444, 89, 96), (1232, 344, 89, 92), (1232, 444, 89, 96)]
    return ANIMATION_Footmen_RIGHT_DOWN
    # стоит _Footmen


def frame_footmen_5S():
    ANIMATION_Footmen_Stay_DOWN = [(33, 19, 64, 92), (33, 19, 64, 92), (33, 19, 64, 92), (33, 19, 64, 92),
                                   (33, 19, 64, 92),
                                   (33, 19, 64, 92), (33, 19, 64, 92), (33, 19, 64, 92)]
